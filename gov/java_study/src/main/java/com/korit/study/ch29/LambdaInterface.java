...
public class LambdaInterface {
    public static void main(String[] args) {
        ...
        Integer functionResult3 = function
                .andThen(s -> {
                    System.out.println("문자열정수를 받아서 실수 자료형으로 리턴");
...
//    Integer functionResult4 = function
//            .compose(d -> {
//                System.out.println("문자열정수를 받아서 실수 자료형으로 리턴");
...
//            .apply(20.5);
//
//        System.out.println(functionResult4);
